...
<script src="js/bootstrap.min.js"></script>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <h3 style="color:white">Time Table Generator</h3>
    </div>
    <ul class="nav navbar-nav">
    
      <li class="" ><a  style="color:black" href="index.php">Home</a></li>
      
      <li><a class="page-scroll" style="color:black"  href="#about">About Us</a></li> 
      <li><a class="page-scroll" style="color:black"  href="#contact">Contact Us</a></li>
      <li><a class="page-scroll" style="color:black"  href="#registration">Registration</a></li>
      <li class="dropdown">
        <a class="dropdown-toggle" style="color:black"  data-toggle="dropdown" href="#">Login
...
<header>
           ...
           <div class="slideshow-container" style="width: 100%;margin-top: 20px" >
...
?>
 ...
 <?php echo @$err; ?>
    ...
    <div class="row" style="margin-bottom: 10px;">
        <input type="text" onkeypress="javascript:return isString(event)"class="form-control" placeholder="Name" name="name"/>
    </div>
    <div class="row" style="margin-bottom: 10px;">
...
<!--                    <i class="fa fa-phone fa-3x wow bounceIn"></i>
                    <p>123-456-6789</p>-->
<div class="panel panel-primary" style="padding:10px 25px;">
...
<?php echo @$err; ?>
   ...
   <div class="row" style="margin-bottom: 10px;">
    ...
    <div class="row" style="margin-bottom: 10px;">
  Male <input type="radio"value="Male" id="gen" name="gen"/>&nbsp;
		Female <input type="radio"value="Female" id="gen" name="gen"/>
</div>
 ...
 <div class="row" style="margin-bottom: 10px;">
  ...
  <p align="center">All rights reserved by college</p>
</footer>
           </div>
        </div>
