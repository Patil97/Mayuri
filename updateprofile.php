...
<div class="col-md-5"> 
           <br><br>
               <h2><font color="">Update Profile</font></h2>
<form method="POST" enctype="multipart/form-data">
  ...
  <td colspan="2"><?php echo @$err; ?></td>
   ...
   <tr>
   <th width="237" scope="row"><font color="">Select Department</font></th>
    <td width="213">
...
<?php 	}
    ...
    <tr>
    <th width="237" scope="row"><font color="">Semester Name</font> </th>
    <td width="213">
