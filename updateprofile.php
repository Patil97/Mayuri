...
<form method="POST" enctype="multipart/form-data">
  ...
  <tr>
    <th width="237" scope="row"><font color="" size="+1">Department Name</font> </th>
    <td width="213">
    ...
    <tr>
    <th width="237" scope="row"><font color="" size="+1">Semester Name</font> </th>
    <td width="213">
