...
$row=mysqli_num_rows($que);
	...
	{
mysqli_query($con,"insert into timeschedule values('','$courseid','$s','$subject_name','$time','$date','$teacher','$day')");	
...
<form method="POST" enctype="multipart/form-data">
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    <th width="237" scope="row">Day </th>
    <td width="213"><select name="day" class="form-control">
