...
if(isset($update))
{
	...
	if(isset($delete))
{
   	mysqli_query($con,"delete from timeschedule  where timeschedule_id='$timeschedule_id' ");
...
<input type="submit" value="Deleted Records" name="delete" class="btn btn-danger"/>
