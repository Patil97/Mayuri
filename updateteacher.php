...
{	
	...
	mysqli_query($con,"update teacher set name='$n',eid='$e',password='$p',mob='$m',address='$a',department_id='$dep_id',sem_id='$semester' where teacher_id='$teacher_id' ");
...
{ 
  ...
  mysqli_query($con,"delete from teacher  where teacher_id='$teacher_id' ");
...
<input type="submit" value="Delete Records" name="delete" class="btn btn-danger"/>
