...
$row=mysqli_num_rows($que);
	...
	{
mysqli_query($con,"insert into teacher values('','$n','$e','$p','$m','$a','$courseid','$s','$status',now())");	
...
<table border="0" class="table">
  ...
  <tr>
    ...
    <td width="213"><input type="text" onkeypress="javascript:return isString(event)" name="n" class="form-control" placeholder="enter your name"/></td>
  </tr>
  <tr>
